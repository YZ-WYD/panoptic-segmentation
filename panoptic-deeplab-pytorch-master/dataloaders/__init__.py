from dataloaders.datasets import cityscapes, coco, combine_dbs, pascal, sbd, forest
...
def make_data_loader(args, **kwargs):
    ...
    if args.dataset == "pascal":
        ...
        train_set = forest.ForestPanoptic(args, split='train')
        val_set = forest.ForestPanoptic(args, split='val')
        num_class = train_set.NUM_CLASSES
